...
export function animateContactSubheading() {
  setTimeout(() => {
    contactSubheading.style.animation =
      "contactSubheadingLoad 0.3s ease-out forwards";
  }, 200);
}
...
export function animateMichaelangeloHand() {
  setTimeout(() => {
    michaelangeloHand.style.animation =
      "michaelangeloHandLoad 0.6s ease-out forwards";
  }, 600);
}
